        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center bg-[#0D0D0D] rounded-b-[32px] rounded-tr-[32px] border border-white/5 px-8 pt-6 pb-12 shadow-2xl">
          ...
          <div className="flex flex-col text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
              <button onClick={handleAdd} className="px-12 py-5 rounded-full font-black text-xl italic uppercase shadow-xl hover:scale-105 active:scale-95 transition-all w-fit" style={{ backgroundColor: currentProduct.color, color: 'black' }}>Pedir Pack x6</button>
