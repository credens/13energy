...
const Features = () => {
  ...
  return (
    <section className="py-24 bg-13black">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {pillars.map((p) => (
            <div 
              key={p.id} 
              className="relative p-10 rounded-[40px] bg-13gray border border-white/5 hover:border-opacity-30 transition-all duration-500 group overflow-hidden hover:shadow-2xl shadow-black"
              style={{ borderTopColor: p.color + '40' }}
            >
              <div 
              ...
              <div className="flex justify-between items-start mb-10">
                ...
                <span className="text-white/10 font-black italic text-6xl font-display leading-none">{p.id}</span>
              </div>
              ...
              <p className="text-[#D1D1D1] text-lg font-medium leading-relaxed mb-6">
                {p.desc}
              </p>
